...
public class Direcional {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * 4 algoritmo 2
		 * 5 grafos
		 * 6 topicos avançados de programação
		 * 7 programação a dispositivos moveis
		 * 8 estrutura de dados
		 * 9 banco de dados
		 * 10 processamento digital de imagens
		 * 11 noções de algebra linear
		 * 12 tradução de linguagens formais
		 * 13 teoria das linguagens formais
		 * */ 
